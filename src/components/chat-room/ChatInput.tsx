      ...
      {chat &&
        ...
        (chat.chat.type !== ChatType.Channel ||
          ...
          <>
            ...
            />
            <button
              className="ml-3 mt-auto flex h-9 w-9 items-center rounded-full bg-blue-500 p-1 pl-2 shadow-[0_0_1px_2px] shadow-blue-600 transition hover:bg-blue-600 active:scale-95 dark:bg-indigo-500 dark:shadow-indigo-600 dark:hover:bg-indigo-600"
